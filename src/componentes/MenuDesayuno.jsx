...
import '../hojas-de-estilo/MenuDesayuno.css'
import { AiFillCloseCircle } from 'react-icons/ai'
import axios from "axios";
import { menuAlmuerzo, opcionesMenu } from "../Rutas/rutas";
...
function MenuDesayuno() {
  ...
  const productosAlmuerzo = () => {
    const menuAlmuerzo = productos.filter(producto => producto.type === 'Desayuno')
    return menuAlmuerzo;
  };
  ...
  return (
    ...
    <div className='menuDesayuno-contenedor'>
      <div className='escogerPedido-contenedorDesayuno'>
        <section className='barra-menu-opciones'>
          <h3 className='titulo-desayuno'>DESAYUNO</h3>
          <h3 className='titulo-Almuerzo' onClick={() => navigate(menuAlmuerzo)}>ALMUERZO - CENA</h3>
        </section>
        <section className='productos-contenedor'>
          {productosAlmuerzo().map((producto, index) => (
            <div key={index} id={producto.id} className='productoDesayuno'
      ...
      <div className='pedidoEscogido-contenedorDesayuno'>
        ...
        <section className='productos-escogidos-contenedor'>
          <table className="tabla-desayuno">
            <tbody>
